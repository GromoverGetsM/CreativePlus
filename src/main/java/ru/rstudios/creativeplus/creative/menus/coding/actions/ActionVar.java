...
public class ActionVar extends AbstractSelectCategoryMenu {
    ...
    public ActionVar (String name) {
        this(name, 1);
    }

    public ActionVar (String name, int rows) {
        this(name, rows, null);
    }

    public ActionVar (String name, int rows, HashMap<Integer, ItemStack> items) {
    ...
    public static class AssignmentCategory extends AbstractCategoryMenu {
        ...
        public AssignmentCategory (String name, int rows) {
            this(name, rows, null);
        }

        public AssignmentCategory (String name, int rows, HashMap<Integer, ItemStack> items) {
            super(name, rows, items);
            this.name = name;
            this.rows = rows;
            this.items = items;
        ...
        @Override
        public @NotNull Inventory getInventory() {
            File inventory = new File(plugin.getDataFolder() + File.separator + "menus" + File.separator + "coding" + File.separator + "actions" + File.separator + "actionvar" + File.separator + this.getClass().getSimpleName() + ".yml");
            Inventory i;
