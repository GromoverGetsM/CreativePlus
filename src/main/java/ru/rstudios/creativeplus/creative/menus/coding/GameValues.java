...
public class GameValues extends CreativeSystemMenu {
    ...
    public GameValues (String name, int rows) {
        this(name, rows, null);
    }

    public GameValues (String name, int rows, HashMap<Integer, ItemStack> items) {
