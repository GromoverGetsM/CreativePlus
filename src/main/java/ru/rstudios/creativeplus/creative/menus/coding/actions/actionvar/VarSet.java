package ru.rstudios.creativeplus.creative.menus.coding.actions.actionvar;
...
public class VarSet extends CodingSystemMenu {
    ...
    public VarSet (String name, int rows) {
        this(name, rows, null);
    }

    public VarSet (String name, int rows, HashMap<Integer, ItemStack> items) {
    ...
    public List<Integer> getDisallowedSlots() {
        ...
        IntStream.rangeClosed(0, 26).forEach(disallowedSlots::add);
