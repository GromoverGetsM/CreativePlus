...
public class MessageEquals extends CodingSystemMenu {
    ...
    public MessageEquals() {
        this("Сообщение равно");
    }

    public MessageEquals (String name) {
        this(name, 1);
    }

    public MessageEquals (String name, int rows) {
        this(name, rows, null);
    }

    public MessageEquals (String name, int rows, HashMap<Integer, ItemStack> items) {
