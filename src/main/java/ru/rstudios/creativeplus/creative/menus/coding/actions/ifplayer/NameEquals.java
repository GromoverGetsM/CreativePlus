...
public class NameEquals extends CodingSystemMenu {
    ...
    public NameEquals (String name, int rows) {
        this(name, rows, null);
    }

    public NameEquals (String name, int rows, HashMap<Integer, ItemStack> items) {
