package ru.rstudios.creativeplus.creative.menus.coding.actions.ifplayer;
...
public class MessageEndsWith extends CodingSystemMenu {
    ...
    public MessageEndsWith() {
        this("Заканчивается на");
    }

    public MessageEndsWith (String name) {
        this(name, 1);
    }

    public MessageEndsWith (String name, int rows) {
        this(name, rows, null);
    }

    public MessageEndsWith (String name, int rows, HashMap<Integer, ItemStack> items) {
