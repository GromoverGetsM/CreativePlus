...
public class MessageStartsWith extends CodingSystemMenu {
    ...
    public MessageStartsWith() {
        this("Начинается с");
    }

    public MessageStartsWith (String name) {
        this(name, 1);
    }

    public MessageStartsWith (String name, int rows) {
        this(name, rows, null);
    }

    public MessageStartsWith (String name, int rows, HashMap<Integer, ItemStack> items) {
