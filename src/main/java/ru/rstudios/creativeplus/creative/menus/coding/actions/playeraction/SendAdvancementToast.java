...
public class SendAdvancementToast extends CodingSystemMenu {
    ...
    public SendAdvancementToast() {
        this("Отправить достижение");
    }

    public SendAdvancementToast (String name) {
        this(name, 1);
    }

    public SendAdvancementToast (String name, int rows) {
        this(name, rows, null);
    }

    public SendAdvancementToast (String name, int rows, HashMap<Integer, ItemStack> items) {
    ...
    public List<Integer> getDisallowedSlots() {
        ...
        disallowedSlots.addAll(Arrays.asList(10, 12, 14, 16, 17));
