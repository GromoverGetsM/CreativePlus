...
public class PlayerPhysicalInteractStarter extends Starter {

    private List<Action> actions = new ArrayList<>();
    private List<Entity> selection = new ArrayList<>();

    public PlayerPhysicalInteractStarter() { this("Физическое взаимодействие"); }

    public PlayerPhysicalInteractStarter(String name) {
        this(name, new ArrayList<>());
    }

    public PlayerPhysicalInteractStarter (String name, List<Action> actions) {
        super(name, actions);
    }
    ...
    public String getName() {
        return "Физическое взаимодействие";
    }
