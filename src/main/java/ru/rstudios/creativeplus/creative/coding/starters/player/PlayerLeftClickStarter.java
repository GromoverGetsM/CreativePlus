...
public class PlayerLeftClickStarter extends Starter {

    private List<Action> actions = new ArrayList<>();
    private List<Entity> selection = new ArrayList<>();

    public PlayerLeftClickStarter() { this("Левый клик"); }

    public PlayerLeftClickStarter(String name) {
        this(name, new ArrayList<>());
    }

    public PlayerLeftClickStarter (String name, List<Action> actions) {
        super(name, actions);
    }
